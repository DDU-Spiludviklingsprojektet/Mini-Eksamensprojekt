              ...
              <>
                    <div id="modal-wrapper-quiz" className="modal-wrapper-quiz">
                        <div className="content">
                            <div className="header">Er du sikker på du vil sende disse svar?</div>
                            <div className="buttons-wrapper">
                                <button onClick={this.hideModal}>Nej</button>
                                <button onClick={this.finishQuiz}>Ja</button>
                            </div>
                        </div>
                    </div>
                        ...
                        {this.state.authorized ?
                            ...
                            <div className="content">
                                ...
                                <div className="footer">
                                    <div className="buttons-wrapper">
                                        <button onClick={this.prevQuestion}>Sidste spørgsmål</button>
                                        {this.state.activeQuestionIdx + 1 < this.state.quiz.questions.length ? <button onClick={this.nextQuestion}>Næste</button> : <button onClick={this.showModal}>Afslut denne quiz</button>}
                                    </div>
                                </div>
                            </div>
