                    ...
                    <div className="body">
                        ...
                        <div className="quiz-data">
                            <div className="left">
                                ...
                                <div className="comments">{this.state.quiz.comments.length} Kommentarer</div>
                            </div>
                            <div className="right">
                                <div className="likes">{this.state.quiz.likes} Likes</div>
                                <div className="others">{this.state.quiz.scores.length} Andre har taget denne quiz</div>
                            </div>
                        </div>

                        <div className="score">
                           Scorer: {this.getScore()}
                        </div>
                        ...
                        <div className="img">
                            <img src={this.state.quiz.imgUrl ? this.state.quiz.imgUrl : 'https://images.unsplash.com/photo-1518770660439-4636190af475?ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dGVjaG5vbG9neXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80'} alt='quiz icon' />
                        </div>
                    </div>
                }
            </div>
